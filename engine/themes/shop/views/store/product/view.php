                            ...
                            <div class="product-gallery js-product-gallery">
                                <div class="product-gallery__body">
                                    ...
                                    <div class="text-center" style="margin-top: 20px">
                                        <a href="<?php echo $product->getImageUrl();?>" rel="gal1" class="fancybox btn btn-success">Приблизить</a>
                                    </div>
    ...
    <div class="container">
        <div>
			...
			<?php if($product->short_description!=''):?>
                <li role="presentation" class="active<?php if(count($images)==0):?>active<?php endif;?>"><a href="#home" aria-controls="home" role="tab" data-toggle="tab">Описание</a></li>
				 <?php endif;?>
                <?php if(count($images)>0):?>
                <li role="presentation">
                    <a href="#profile" aria-controls="profile" role="tab" data-toggle="tab">Галлерея</a>
                </li>
            ...
            <div class="tab-content">
                        ...
                        <?php foreach ($images as $key => $image): if($image->art) continue;?>
                            <li>
                                <a class="fancybox" href="<?= $image->getImageUrl(); ?>" rel="gal1">
                                    <img src="<?= $image->getImageUrl(310, 310, true); ?>" alt=""
                                         class="">
                                </a>
                            </li>
                ...
                <div role="tabpanel" class="tab-pane" id="messages">
                    <?php $this->widget('application.modules.store.widgets.LinkedProductsWidget',['product'=>$product,'limit'=>6]); ?>
                </div>
                <?php endif;?>
