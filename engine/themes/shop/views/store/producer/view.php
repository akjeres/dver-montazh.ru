    ...
    <div class="container">
        <div class="row">
                ...
                <div class="search">
                    <div class="catalog-filter">
                        ...
                        <?php if($brand->getImageUrl()):?>
                            <p class="text-center"><b>Компания HomeDoors является официальным дилером <?= $brand->name_short;?></b></p>
                            <!--a href="<?=$brand->getImageUrl();?>" class="fancybox"><img src="<?=$brand->getImageUrl(150);?>" alt="<?=$brand->name;?>" width="100%;"></a-->
                        <?php endif;?>
                        <?php if($brand->slug=='varadoor'):?>
                            <div class="text-center">
                                <a href="/buklet-katalog-2017.pdf" target="_blank" alt="Буклет двери Varadoor" title="Буклет двери Varadoor">
                                    <img src="/images/download.png" width="30px"><br>
                                    <small>Скачать буклет Varadoor</small>
                                </a>
                            </div>
            ...
            <style>
                ...
                <?php if(!in_array($brand->slug,['arche','morelli'])):?>
