                    ...
                    <div class="image-template hidden form-group">
                        <div class="row">
                            ...
                            <div class="col-xs-1 col-sm-1">
                                <label for="">Код</label>
                                <input type="text" class="image-art form-control"/>
                            </div>
                    ...
                    <table class="table table-hover">
                        ...
                        <?php foreach ($model->images as $image): ?>
                            <tr>
                                ...
                                <td>
                                    <?= CHtml::textField('ProductImage['.$image->id.'][art]', $image->art,
                                        ['class' => 'form-control']) ?>
                                </td>
                                <td>
...
<script type="text/javascript">
    $(function () {
        ...
        $('#button-add-image').on('click', function () {
            ...
            newImage.find(".image-art").attr('name', 'ProductImage[new_' + key + '][art]');
